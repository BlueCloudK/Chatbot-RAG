...
`RblService` is included in this folder for standalone benchmark demos when needed. SignalR, dashboard, and Worker Service features are intentionally kept in the ProductGroup variant only.
